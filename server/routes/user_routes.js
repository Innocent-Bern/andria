...
const { user_sign_up, user_login, available_books,
    google_book_search, find_book_db, add_new_copy,
    get_book_google, upload_image } = require("../controllers/user_controller");
...
router.post('/get_book_google', get_book_google)

// find a specific book from database
router.post('/find_book', find_book_db);

// upload book image to gcp
router.post('/upload_image', upload.single('testFile'), upload_image);
